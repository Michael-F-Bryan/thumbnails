...
fn bindgen_test_layout_IUnknownVtbl() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<IUnknownVtbl>())).QueryInterface as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<IUnknownVtbl>())).AddRef as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<IUnknownVtbl>())).Release as *const _
                as usize
        },
        16usize,
        concat!(
...
fn bindgen_test_layout_IUnknown() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<IUnknown>())).lpVtbl as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
...
pub struct IClassFactoryVtbl {
    ...
    >,
    pub AddRef: ::std::option::Option<
        unsafe extern "C" fn(This: *mut IClassFactory) -> ULONG,
    >,
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(This: *mut IClassFactory) -> ULONG,
    >,
...
#[test]
fn bindgen_test_layout_IClassFactoryVtbl() {
    assert_eq!(
        ::std::mem::size_of::<IClassFactoryVtbl>(),
        40usize,
        concat!("Size of: ", stringify!(IClassFactoryVtbl))
    );
    assert_eq!(
        ::std::mem::align_of::<IClassFactoryVtbl>(),
        8usize,
        concat!("Alignment of ", stringify!(IClassFactoryVtbl))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<IClassFactoryVtbl>())).QueryInterface
                as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(IClassFactoryVtbl),
            "::",
            stringify!(QueryInterface)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<IClassFactoryVtbl>())).AddRef as *const _
                as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<IClassFactoryVtbl>())).Release as *const _
                as usize
        },
        16usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<IClassFactoryVtbl>())).CreateInstance
                as *const _ as usize
        },
        24usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<IClassFactoryVtbl>())).LockServer as *const _
                as usize
        },
        32usize,
        concat!(
...
#[test]
fn bindgen_test_layout_IClassFactory() {
    assert_eq!(
        ::std::mem::size_of::<IClassFactory>(),
        8usize,
        concat!("Size of: ", stringify!(IClassFactory))
    );
    assert_eq!(
        ::std::mem::align_of::<IClassFactory>(),
        8usize,
        concat!("Alignment of ", stringify!(IClassFactory))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<IClassFactory>())).lpVtbl as *const _
                as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(IClassFactory),
            "::",
            stringify!(lpVtbl)
        )
    );
}
impl Default for IClassFactory {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
